...
let laterYears = myAge - 2; // already accounted for the first two years above
laterYears *= 4; // calculate dog years for later human years, and reassign to the laterYears variable
